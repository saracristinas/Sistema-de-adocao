...
const Cadastro = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post("http://localhost:8080/auth/register", novoUsuario);
            ...
            if (response.status === 201 || response.status === 200) {
                ...
                alert(`Cadastro realizado com sucesso! Nome: ${usuarioCriado.name}, ID: ${usuarioCriado.id}`);
